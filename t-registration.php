...
<body>
    ...
    <label>G-drive Link 
        <i class="fas fa-info-circle" 
           ...
           title="PLEASE UPLOAD NECESSARY DOCUMENTS:<br> Resume (specify subject expertise), Certification of Enrollment, Transcript of Records/Grade Slip, Academic Certificates & Parental Consent Form.">
        </i>
    </label>
