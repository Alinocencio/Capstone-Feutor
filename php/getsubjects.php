...
// Display search form with enhanced features
...
echo '<button type="submit" class="btn btn-primary ml-2">Search</button>';
echo '<a href="?view_all" class="btn btn-reset ml-2">Reset to All</a>';
echo '</form>';

// Display subjects in a table with only "Subject Name" and "Action" columns
