                  ...
                  <div class='modal-dialog' role='document'>
                    <div class='modal-content'>
                      <div class='modal-header'>
                        <h5 class='modal-title' id='detailsModalLabel{$sessionID}'>Session Details</h5>
                        <button type='button' class='close' data-dismiss='modal' aria-label='Close'>
                          <span aria-hidden='true'>&times;</span>
                        </button>
                      </div>
                      <div class='modal-body'>
                        <p><strong>Student:</strong> " . htmlspecialchars($row['studentFullName']) . "</p>
                        <p><strong>Teaching Mode:</strong> " . htmlspecialchars($row['teachingMode']) . "</p>
                        <p><strong>Subject:</strong> " . htmlspecialchars($row['subject']) . "</p>
                        <p><strong>Date:</strong> " . htmlspecialchars($row['formattedSessionDate']) . "</p>
                        <p><strong>Time:</strong> " . htmlspecialchars($row['formattedStartTime']) . " - " . htmlspecialchars($row['formattedEndTime']) . "</p>   
                        <p><strong>Need:</strong> " . htmlspecialchars($row['need']) . "</p>
                      </div>
                      </div>
                    </div>
                  </div>
